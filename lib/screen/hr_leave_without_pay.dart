...
import 'hr_history_leave_without.dart';

class HrLeaveWithout extends StatefulWidget {
  @override
  _HrLeaveWithoutState createState() => _HrLeaveWithoutState();
}

class _HrLeaveWithoutState extends State<HrLeaveWithout> {
            ...
            children: [
              RaisedButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => HistoryWithout()));
              },
                child: Text("ส่ง"),
