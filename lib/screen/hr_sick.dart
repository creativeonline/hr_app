...
import 'hr_history_personal_leave.dart';
import 'hr_history_sick.dart';

class HrSick extends StatefulWidget {
  final int userId;
  final int trailId;
  final int editStatus;

  const HrSick({Key key,
    this.userId,
    this.editStatus,
    this.trailId,
  })
      : super(key: key);
  @override
  _HrSickState createState() => _HrSickState();

}
class _HrSickState extends State<HrSick> {
