...
import 'hr_history_military.dart';

class HrMilitary extends StatefulWidget {
  @override
  _HrMilitaryState createState() => _HrMilitaryState();
}

class _HrMilitaryState extends State<HrMilitary> {
            ...
            children: [
              RaisedButton(onPressed: (){
                Navigator.push(context, MaterialPageRoute(
                    builder: (context) => HrHistoryMilitary()));
              },
                child: Text("ส่ง"),
