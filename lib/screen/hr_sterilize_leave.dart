...
import 'hr_history_sterilize.dart';

class HrSterilize extends StatefulWidget {
  @override
  _HrSterilizeState createState() => _HrSterilizeState();
}

class _HrSterilizeState extends State<HrSterilize> {
           ...
           children: [
             RaisedButton(onPressed: (){
               Navigator.push(context, MaterialPageRoute(
                   builder: (context) => HistorySterilize()));
             },
               child: Text("ส่ง"),
